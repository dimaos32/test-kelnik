...
/* harmony import */ var _modules_range_filter__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/range-filter */ "./js/modules/range-filter.js");
/* harmony import */ var _modules_search_result__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/search-result */ "./js/modules/search-result.js");
/* harmony import */ var _modules_init_scroll_up__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/init-scroll-up */ "./js/modules/init-scroll-up.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_range_filter__WEBPACK_IMPORTED_MODULE_2__["initRangeSlider"])(); // Modules
  // ---------------------------------
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_search_result__WEBPACK_IMPORTED_MODULE_3__["initSearchResult"])();
    Object(_modules_init_scroll_up__WEBPACK_IMPORTED_MODULE_4__["initScrollUp"])();
  });
}); // ---------------------------------
...
var API_URL = 'https://dimaos32.github.io/test-kelnik/data/apartments.json';
var MILISECONDS_IN_SECOND = 1000; // ms
...
var checkboxes = document.querySelectorAll('.search-filter__room input');
var rangeFilters = document.querySelectorAll('.search-filter__range-item');
...
var loadData = function loadData(onSuccess, onError) {
  disableFilters();
  ...
  xhr.addEventListener('timeout', function () {
    onError("\u0417\u0430\u043F\u0440\u043E\u0441 \u043D\u0435 \u0443\u0441\u043F\u0435\u043B \u0432\u044B\u043F\u043E\u043B\u043D\u0438\u0442\u044C\u0441\u044F \u0437\u0430 ".concat(xhr.timeout / MILISECONDS_IN_SECOND, " \u0441"));
  });
  enableFilters();
};
...
var MIN_PAGE_Y_OFFSET = 250; // px

var initScrollUp = function initScrollUp() {
  var scrollUpBtn = document.querySelector('.apartment-search__scroll-up-btn');
  ...
  var onScrollUpBtnClick = function onScrollUpBtnClick() {
    window.scrollTo(0, 0);
...
/* harmony import */ var _backend__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./backend */ "./js/modules/backend.js");
/* harmony import */ var _search_result__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./search-result */ "./js/modules/search-result.js");
...
/* harmony import */ var _vendor_nouislider__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_vendor_nouislider__WEBPACK_IMPORTED_MODULE_3__);
...
var initRangeSlider = function initRangeSlider() {
  ...
  var checkboxGroup = filter.querySelector('.search-filter__rooms');
  var checkboxes = checkboxGroup.querySelectorAll('.search-filter__room input');
  var priceFilter = filter.querySelector('.search-filter__range--price');
  var priceRange = priceFilter.querySelector('.search-filter__range-item');
  var priceValues = priceFilter.querySelectorAll('.search-filter__range-value');
  var priceInputs = priceFilter.querySelectorAll('input');
  var squareFilter = filter.querySelector('.search-filter__range--square');
  var squareRange = squareFilter.querySelector('.search-filter__range-item');
  var squareValues = squareFilter.querySelectorAll('.search-filter__range-value');
  var squareInputs = squareFilter.querySelectorAll('input');
  var resetBtn = filter.querySelector('.search-filter__reset-btn');

  var onPriceRangeUpdate = function onPriceRangeUpdate(values, handle) {
    priceValues[handle].textContent = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["formatPrice"])(Math.round(values[handle]));
  };

  var onSquareRangeUpdate = function onSquareRangeUpdate(values, handle) {
    squareValues[handle].textContent = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["formatPrice"])(Math.round(values[handle]));
  };

  var onPriceRangeChange = function onPriceRangeChange(values, handle) {
    priceInputs[handle].value = Math.round(values[handle]);
    Object(_backend__WEBPACK_IMPORTED_MODULE_1__["loadData"])(_search_result__WEBPACK_IMPORTED_MODULE_2__["cbLoadDataSuccess"], _search_result__WEBPACK_IMPORTED_MODULE_2__["cbLoadDataError"]);
  };

  var onSquareRangeChange = function onSquareRangeChange(values, handle) {
    squareInputs[handle].value = Math.round(values[handle]);
    Object(_backend__WEBPACK_IMPORTED_MODULE_1__["loadData"])(_search_result__WEBPACK_IMPORTED_MODULE_2__["cbLoadDataSuccess"], _search_result__WEBPACK_IMPORTED_MODULE_2__["cbLoadDataError"]);
  };

  var onResetBtnClick = function onResetBtnClick() {
  ...
  var onCheckboxChange = function onCheckboxChange(_ref) {
  ...
  _vendor_nouislider__WEBPACK_IMPORTED_MODULE_3___default.a.create(priceRange, {
    start: DefaultSettings.priceRange.start,
    connect: true,
    step: DefaultSettings.priceRange.step,
    range: DefaultSettings.priceRange.range
  });
  _vendor_nouislider__WEBPACK_IMPORTED_MODULE_3___default.a.create(squareRange, {
...
/***/ "./js/modules/search-result.js":
/*!*************************************!*\
  !*** ./js/modules/search-result.js ***!
  \*************************************/
/*! exports provided: initSearchResult, cbLoadDataSuccess, cbLoadDataError */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initSearchResult", function() { return initSearchResult; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "cbLoadDataSuccess", function() { return cbLoadDataSuccess; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "cbLoadDataError", function() { return cbLoadDataError; });
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils */ "./js/modules/utils.js");
/* harmony import */ var _backend__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./backend */ "./js/modules/backend.js");
...
var FIRST_LOAD = 5; // apartments

var LOAD_MORE = 20; // apartments

var currentData = [];
var searchResult = document.querySelector('.search-result');
var resultList = searchResult.querySelector('.search-result__list');
var loadMoreBtn = searchResult.querySelector('.search-result__load-more-btn');
var sortBar = searchResult.querySelector('.sort-bar__list');
var checkboxGroup = document.querySelector('.search-filter__rooms');
var checkboxes = checkboxGroup.querySelectorAll('.search-filter__room input');
var filterMinPrice = document.querySelector('#filter-min-price');
var filterMaxPrice = document.querySelector('#filter-max-price');
var filterMinSquare = document.querySelector('#filter-min-square');
var filterMaxSquare = document.querySelector('#filter-max-square');
var apartmentTemplate = document.querySelector('#apartment-card').content.querySelector('.apartment-card');
var errorMessageTemplate = document.querySelector('#error-request-response').content.querySelector('.error-request-response');

var renderApartmentCard = function renderApartmentCard(data) {
  var img = data.img,
      title = data.title,
      square = data.square,
      floor = data.floor,
  ...
  var card = apartmentTemplate.cloneNode(true);
  var cardImg = card.querySelector('.apartment-card__img img');
  var cardTitle = card.querySelector('.apartment-card__title');
  var cardSquare = card.querySelector('.apartment-card__square');
  var cardFloor = card.querySelector('.apartment-card__floor');
  var cardPrice = card.querySelector('.apartment-card__price');
  cardImg.src = "img/".concat(img.location, "/").concat(img.file);
  cardImg.alt = img.altText;
  cardTitle.textContent = title;
  cardSquare.innerHTML = "".concat(square.toString().replace('.', ','), " <span class=\"unit\">\u043C\xB2</span>");
  cardFloor.innerHTML = "<span class=\"accent\">".concat(floor.current, "</span> \u0438\u0437 ").concat(floor.total, " <span class=\"unit\">\u044D\u0442\u0430\u0436</span>");
  cardPrice.innerHTML = "".concat(Object(_utils__WEBPACK_IMPORTED_MODULE_0__["formatPrice"])(price), " <span class=\"unit\">\u20BD</span>");
  listItem.classList.add('search-result__item');
  listItem.append(card);
  resultList.append(listItem); // console.log(data['square'], data['floor']['current'], data['price']);
};

var renderErrorMessage = function renderErrorMessage(message) {
  var listItem = document.createElement('li');
...
var renderNextNCards = function renderNextNCards() {
  var quantity = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : LOAD_MORE;
  var startIndex = resultList.children.length;
  var endIndex = currentData.length - startIndex < quantity ? currentData.length : startIndex + quantity;
...
var cbLoadDataSuccess = function cbLoadDataSuccess(data) {
  var currentSortBtn = sortBar.querySelector('.sort-bar__btn.current');
  var roomsFilterIsActive = false;
  ...
  currentData = data.filter(function (apartment) {
    var currentCheckbox = checkboxGroup.querySelector("[data-rooms=\"".concat(apartment.rooms, "\"]"));
    return apartment.price >= filterMinPrice.value && apartment.price <= filterMaxPrice.value && apartment.square >= filterMinSquare.value && apartment.square <= filterMaxSquare.value && (!roomsFilterIsActive || currentCheckbox.checked);
  });
...
var onLoadMoreBtnClick = function onLoadMoreBtnClick() {
  renderNextNCards(LOAD_MORE);
  loadMoreBtn.blur();
};

var sortCards = function sortCards(cards, sortKey) {
  var direction = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'direct';
...
var onSortBarClick = function onSortBarClick(_ref) {
  var target = _ref.target;
  var btn = target.closest('.sort-bar__btn');
  var renderedCards = currentData.slice(0, resultList.children.length);

  if (btn && !btn.disabled) {
    if (btn.classList.contains('current')) {
      btn.dataset.sortDirection = btn.dataset.sortDirection === 'direct' ? 'reverse' : 'direct';
    } else {
      var currentBtn = sortBar.querySelector('.sort-bar__btn.current');
...
var cbLoadDataError = function cbLoadDataError(data) {
  renderErrorMessage(data);
};

var initSearchResult = function initSearchResult() {
  var filter = document.querySelector('.search-filter');
  ...
  Object(_backend__WEBPACK_IMPORTED_MODULE_1__["loadData"])(cbLoadDataSuccess, cbLoadDataError);
...
var formatPrice = function formatPrice(num) {
  return num < 1000 ? num.toString() : "".concat(formatPrice(num.toString().slice(0, -3)), " ").concat(num.toString().slice(-3));
};
