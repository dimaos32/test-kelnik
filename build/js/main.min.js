...
var initRangeSlider = function initRangeSlider() {
  ...
  var priceRange = filter.querySelector('.search-filter__range-item--price');
  var squareRange = filter.querySelector('.search-filter__range-item--square');
  _vendor_nouislider__WEBPACK_IMPORTED_MODULE_0___default.a.create(priceRange, {
  ...
  _vendor_nouislider__WEBPACK_IMPORTED_MODULE_0___default.a.create(squareRange, {
    start: [33, 123],
    connect: true,
    range: {
      'min': 0,
...
/*!*************************************!*\
  !*** ./js/modules/search-result.js ***!
  \*************************************/
/*! exports provided: initSearchResult */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var initSearchResult = function initSearchResult() {
  ...
  var resultList = document.querySelector('.search-result__list');
