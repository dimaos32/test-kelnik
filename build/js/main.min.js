...
var REQUEST_LOADING_TIME = 400; // ms
...
var renderApartmentCard = function renderApartmentCard(data) {
  ...
  cardFloor.innerHTML = "<span>".concat(floor.current, "</span> \u0438\u0437 ").concat(floor.total);
  cardPrice.textContent = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["formatPrice"])(price);
